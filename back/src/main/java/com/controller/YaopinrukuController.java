...
//                            yaopinrukuEntity.setYaopinId(Integer.valueOf(data.get(0)));   //猪饲料 要改的
//                            yaopinrukuEntity.setYuangongId(Integer.valueOf(data.get(0)));   //员工 要改的
//                            yaopinrukuEntity.setYaopinrukuUuidNumber(data.get(0));                    //猪饲料入库编号 要改的
//                            yaopinrukuEntity.setYaopinrukuName(data.get(0));                    //入库标题 要改的
//                            yaopinrukuEntity.setYaopinrukuTypes(Integer.valueOf(data.get(0)));   //猪饲料入库类型 要改的
...
//                            yaopinrukuEntity.setCreateTime(date);//时间
                        ...
                        if(yaopinrukuEntities_yaopinrukuUuidNumber.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [猪饲料入库编号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
