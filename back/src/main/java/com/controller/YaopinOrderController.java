...
public class YaopinOrderController {
    ...
    @Autowired
    private YaopinService yaopinService;//猪饲料
    @Autowired
...
//                            yaopinOrderEntity.setYaopinId(Integer.valueOf(data.get(0)));   //猪饲料 要改的
...
//                            yaopinOrderEntity.setYaopinOrderFile(data.get(0));                    //仓管证明 要改的
    ...
    */
    ...
    public R add(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        Integer addressId = Integer.valueOf(String.valueOf(params.get("addressId")));
            ...
            String yaopinOrderFile = String.valueOf(params.get("yaopinOrderFile"));//仓管证明
...
//            String yaopinOrderYesnoText = String.valueOf(params.get("yaopinOrderYesnoText"));//审核意见
        ...
        for (Map<String, Object> map : yaopins) {
           //取值
            ...
            yaopinOrderEntity.setYaopinId(yaopinId);//猪饲料
                        yaopinOrderEntity.setYonghuId(userId);//用户
            yaopinOrderEntity.setBuyNumber(buyNumber);//购买数量 ？？？？？？
            yaopinOrderEntity.setYaopinOrderFile(yaopinOrderFile);//仓管证明 ？？？？？？
    ...
    */
    ...
    public R refund(Integer id, HttpServletRequest request){
        ...
        String role = String.valueOf(request.getSession().getAttribute("role"));
            ...
            yaopinService.updateById(yaopinEntity);//更新订单中猪饲料的信息
