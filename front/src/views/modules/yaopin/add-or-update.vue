    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="猪饲料名称" prop="yaopinName">
                       <el-input v-model="ruleForm.yaopinName"
                                 placeholder="猪饲料名称" clearable  :readonly="ro.yaopinName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="猪饲料名称" prop="yaopinName">
                           <el-input v-model="ruleForm.yaopinName"
                                     placeholder="猪饲料名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="猪饲料编号" prop="yaopinUuidNumber">
                       <el-input v-model="ruleForm.yaopinUuidNumber"
                                 placeholder="猪饲料编号" clearable  :readonly="ro.yaopinUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="猪饲料编号" prop="yaopinUuidNumber">
                           <el-input v-model="ruleForm.yaopinUuidNumber"
                                     placeholder="猪饲料编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.yaopinPhoto" label="猪饲料照片" prop="yaopinPhoto">
                        <file-upload
                            tip="点击上传猪饲料照片"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.yaopinPhoto" label="猪饲料照片" prop="yaopinPhoto">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="配方饲料" prop="chufangyaoTypes">
                        <el-select v-model="ruleForm.chufangyaoTypes" :disabled="ro.chufangyaoTypes" placeholder="请选择配方饲料">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="配方饲料" prop="chufangyaoValue">
                        <el-input v-model="ruleForm.chufangyaoValue"
                            placeholder="配方饲料" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="猪饲料类型" prop="yaopinTypes">
                        <el-select v-model="ruleForm.yaopinTypes" :disabled="ro.yaopinTypes" placeholder="请选择猪饲料类型" @change="yaopinTypesChange">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="猪饲料类型" prop="yaopinValue">
                        <el-input v-model="ruleForm.yaopinValue"
                            placeholder="猪饲料类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="猪饲料库存" prop="yaopinKucunNumber">
                       <el-input v-model="ruleForm.yaopinKucunNumber"
                                 placeholder="猪饲料库存" clearable  :readonly="ro.yaopinKucunNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="猪饲料库存" prop="yaopinKucunNumber">
                           <el-input v-model="ruleForm.yaopinKucunNumber"
                                     placeholder="猪饲料库存" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="猪饲料原价" prop="yaopinOldMoney">
                       <el-input v-model="ruleForm.yaopinOldMoney"
                                 placeholder="猪饲料原价" clearable  :readonly="ro.yaopinOldMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="猪饲料原价" prop="yaopinOldMoney">
                           <el-input v-model="ruleForm.yaopinOldMoney"
                                     placeholder="猪饲料原价" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.yaopinGongxiaoContent"  label="猪饲料功效" prop="yaopinGongxiaoContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yaopinGongxiaoContent" label="猪饲料功效" prop="yaopinGongxiaoContent">
                            <span v-html="ruleForm.yaopinGongxiaoContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.yaopinJinjiContent"  label="猪饲料禁忌" prop="yaopinJinjiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yaopinJinjiContent" label="猪饲料禁忌" prop="yaopinJinjiContent">
                            <span v-html="ruleForm.yaopinJinjiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.yaopinContent"  label="猪饲料说明" prop="yaopinContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yaopinContent" label="猪饲料说明" prop="yaopinContent">
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   yaopinName: [
                              { required: true, message: '猪饲料名称不能为空', trigger: 'blur' },
                          ],
                   yaopinUuidNumber: [
                              { required: true, message: '猪饲料编号不能为空', trigger: 'blur' },
                          ],
                   yaopinPhoto: [
                              { required: true, message: '猪饲料照片不能为空', trigger: 'blur' },
                          ],
                   chufangyaoTypes: [
                              { required: true, message: '配方饲料不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   yaopinTypes: [
                              { required: true, message: '猪饲料类型不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   yaopinKucunNumber: [
                              { required: true, message: '猪饲料库存不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   yaopinOldMoney: [
                              { required: true, message: '猪饲料原价不能为空', trigger: 'blur' },
                   ...
                   yaopinClicknum: [
                              { required: true, message: '猪饲料热度不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   yaopinGongxiaoContent: [
                              { required: true, message: '猪饲料功效不能为空', trigger: 'blur' },
                          ],
                   yaopinJinjiContent: [
                              { required: true, message: '猪饲料禁忌不能为空', trigger: 'blur' },
                          ],
                   yaopinContent: [
                              { required: true, message: '猪饲料说明不能为空', trigger: 'blur' },
                          ],
                   shangxiaTypes: [
